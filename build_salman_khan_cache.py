#!/usr/bin/env python3
"""Build activity cache for Salman Khan from CSV export"""
...
def main():
    print("="*80)
    print("Building Salman Khan's Activity Cache from CSV")
    print("="*80)

    csv_path = Path.home() / "Downloads" / "salman_khan" / "activities.csv"
    cache_dir = Path.home() / ".strava_guru_cache" / "salman_khan"
